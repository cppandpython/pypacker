...
def obfuscate(p):
    ...
    __Init.__reduce__ = lambda _: (main, (_module,))
    _main = f'main=lambda {_h}:__builtins__.getattr(__builtins__,{chr_str("exec")})(__builtins__.getattr(__builtins__.getattr(__builtins__,{chr_str("bytes")}),{chr_str("fromhex")})({_h}),__builtins__.getattr(__builtins__,{chr_str("globals")})())'.encode(ENCODING).hex()
...
f'__builtins__.getattr(__builtins__.getattr(__builtins__.getattr(__builtins__,{chr_str("globals")})().get({chr_str("__builtins__")}),{chr_str("__import__")})({chr_str("pickle")}),{chr_str("loads")})({pickle(__Init())})'
